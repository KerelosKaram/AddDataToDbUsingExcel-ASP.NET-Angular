...
@Component({
  selector: 'app-psku-item-elamir-sql2017',
  templateUrl: './psku-item-elamir-sql2017.component.html',
  styleUrls: ['./psku-item-elamir-sql2017.component.scss']
})
export class PskuItemElamirSql2017Component {
  ...
  downloadFile(): void {
    ...
    this.http
      .get(`${environment.apiUrl}/template/download?templateName=PSKUItemElamirSql2017`, {
        responseType: 'blob',
        headers,
      })
      .subscribe(
        (response) => {
          ...
          a.href = url;
          a.download = 'PSKUItemElamirSql2017_API.xlsx'; // Set the default name for the downloaded file
          a.click();
